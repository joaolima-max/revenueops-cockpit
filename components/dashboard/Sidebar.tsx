...
const navSections = [
  ...
  },
  {
    ...
    items: [
      {
        label: 'Incidentes', href: '/dashboard/incidentes',
      ...
      {
        label: 'Métricas Op.', href: '/dashboard/metricas-op',
        icon: <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>,
      },
      {
        label: 'Volumetria', href: '/dashboard/volumetria',
        icon: <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" /></svg>,
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: 'Parâmetros', href: '/dashboard/parametros',
        icon: <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" /></svg>,
      },
      {
    ...
    <aside className="w-60 bg-black border-r border-gray-800/40 flex flex-col min-h-screen flex-shrink-0">
      <div className="p-5 border-b border-gray-800/40">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <p className="text-white font-bold text-sm leading-none tracking-tight">XDEAL</p>
            <p className="text-gray-500 text-xs mt-0.5">Deal Intelligence</p>
          </div>
        </div>
      </div>
            ...
            <div key={section.title}>
              ...
              <div className="space-y-0.5">
                {section.items.map((item) => {
                  if ((item as { adminOnly?: boolean }).adminOnly && role !== 'ADMIN') return null
      ...
      <div className="p-3 border-t border-gray-800/40">
        ...
        <Link href="/dashboard/perfil" className="w-full flex items-center gap-2 px-2.5 py-2 text-gray-600 hover:text-gray-300 hover:bg-gray-800/40 rounded-lg text-xs transition-colors">
        ...
        <button
          ...
          className="w-full flex items-center gap-2 px-2.5 py-2 text-gray-600 hover:text-gray-300 hover:bg-gray-800/40 rounded-lg text-xs transition-colors"
        >
          <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
